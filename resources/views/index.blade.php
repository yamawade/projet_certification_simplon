                    ...
                    <div class="col-sm-5 card">
                        ...
                        <form class="login-form" action="{{ route('payment.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                <input type="number" name="commande_id" value="{{ request()->get('commande_id') }}" class="form-control" readonly>
                            </div>
                            <div class="form-group">
                                <input type="number" name="price" value="{{ request()->get('montantTotal') }}" class="form-control" placeholder="Montant" readonly>
                            </div>
                            <div class="form-group">
